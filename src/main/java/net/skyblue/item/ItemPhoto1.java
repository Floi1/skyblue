...
import net.skyblue.procedure.ProcedurePhoto1RightClickedInAir;
...
public class ItemPhoto1 extends ElementsSkyblueMod.ModElement {
	@GameRegistry.ObjectHolder("skyblue:photo_1")
	public static final Item block = null;
	public ItemPhoto1(ElementsSkyblueMod instance) {
		super(instance, 220);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("skyblue:photo_1", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("photo_1");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedurePhoto1RightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
