...
public class SkykeyItem extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:skykey")
	public static final Item block = null;

	public SkykeyItem(SkyblueModElements instance) {
		super(instance, 77);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			SkykeyRightClickedInAirProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
