...
public class NormalskyItem extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:normalsky")
	public static final Item block = null;

	public NormalskyItem(SkyblueModElements instance) {
		super(instance, 119);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			NormalskyRightClickedInAirProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
