...
public class GuiFace1 extends ElementsSkyblueMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiFace1(ElementsSkyblueMod instance) {
		super(instance, 219);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				SkyblueMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("skyblue:textures/face_1.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("skyblue:textures/face1.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + -99, this.guiTop + -120, 0, 0, 200, 245, 200, 245);
		}
		...
		public void initGui() {
			super.initGui();
			this.guiLeft = (this.width - 1) / 2;
			this.guiTop = (this.height - 1) / 2;
		...
		protected void actionPerformed(GuiButton button) {
			SkyblueMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
