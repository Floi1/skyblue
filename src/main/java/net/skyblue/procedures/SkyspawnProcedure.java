...
public class SkyspawnProcedure {
	public static void execute(IWorld world, double x, double y, double z) {
		for (int index0 = 0; index0 < 2; index0++) {
			...
			world.setBlockState(new BlockPos(x, y, z - 1), Blocks.AIR.getDefaultState(), 3);
			world.setBlockState(new BlockPos(x + 1, y - 1, z), Blocks.OBSIDIAN.getDefaultState(), 3);
			world.setBlockState(new BlockPos(x, y - 1, z - 1), Blocks.OBSIDIAN.getDefaultState(), 3);
			world.setBlockState(new BlockPos(x - 1, y - 1, z), Blocks.OBSIDIAN.getDefaultState(), 3);
			world.setBlockState(new BlockPos(x, y - 1, z + 1), Blocks.OBSIDIAN.getDefaultState(), 3);
			world.setBlockState(new BlockPos(x, y - 1, z), Blocks.OBSIDIAN.getDefaultState(), 3);
		}
	}
}