...
public class GreenEntityCollidesInTheBlockProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SkyblueMod.LOGGER.warn("Failed to load dependency entity for procedure GreenEntityCollidesInTheBlock!");
			return;
		}
