...
public class SkyPlayerEntersDimensionProcedure {
	public static void execute(Entity entity) {
		...
		if (Math.random() <= 0.01) {
			...
			if (entity instanceof ServerPlayerEntity && !((ServerPlayerEntity) entity).world.isRemote()) {
				RegistryKey<World> destinationType = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("skyblue:l_1"));
				if (((ServerPlayerEntity) entity).world.getDimensionKey() == destinationType)
					return;
				ServerWorld nextWorld = ((ServerPlayerEntity) entity).getServer().getWorld(destinationType);
				if (nextWorld != null) {
			...
			if (entity instanceof ServerPlayerEntity && !((ServerPlayerEntity) entity).world.isRemote()) {
				RegistryKey<World> destinationType = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("skyblue:m_1"));
				if (((ServerPlayerEntity) entity).world.getDimensionKey() == destinationType)
					return;
				ServerWorld nextWorld = ((ServerPlayerEntity) entity).getServer().getWorld(destinationType);
				if (nextWorld != null) {
			...
			if (entity instanceof ServerPlayerEntity && !((ServerPlayerEntity) entity).world.isRemote()) {
				RegistryKey<World> destinationType = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("skyblue:n_1"));
				if (((ServerPlayerEntity) entity).world.getDimensionKey() == destinationType)
					return;
				ServerWorld nextWorld = ((ServerPlayerEntity) entity).getServer().getWorld(destinationType);
				if (nextWorld != null) {
			...
			if (entity instanceof ServerPlayerEntity && !((ServerPlayerEntity) entity).world.isRemote()) {
				RegistryKey<World> destinationType = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("skyblue:o_1"));
				if (((ServerPlayerEntity) entity).world.getDimensionKey() == destinationType)
					return;
				ServerWorld nextWorld = ((ServerPlayerEntity) entity).getServer().getWorld(destinationType);
				if (nextWorld != null) {
			...
			if (entity instanceof ServerPlayerEntity && !((ServerPlayerEntity) entity).world.isRemote()) {
				RegistryKey<World> destinationType = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("skyblue:p_1"));
				if (((ServerPlayerEntity) entity).world.getDimensionKey() == destinationType)
					return;
				ServerWorld nextWorld = ((ServerPlayerEntity) entity).getServer().getWorld(destinationType);
				if (nextWorld != null) {
