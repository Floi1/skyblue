...
public class ProcedureDim4telpert extends ElementsSkyblueMod.ModElement {
	public ProcedureDim4telpert(ElementsSkyblueMod instance) {
		super(instance, 123);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dim4telpert!");
			return;
		}
