...
public class ProcedureGreen3EntityWalksOnTheBlock extends ElementsSkyblueMod.ModElement {
	public ProcedureGreen3EntityWalksOnTheBlock(ElementsSkyblueMod instance) {
		super(instance, 198);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Green3EntityWalksOnTheBlock!");
			return;
		}
