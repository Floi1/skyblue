...
public class ProcedureSevenzeroEntityWalksOnTheBlock extends ElementsSkyblueMod.ModElement {
	public ProcedureSevenzeroEntityWalksOnTheBlock(ElementsSkyblueMod instance) {
		super(instance, 6);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure SevenzeroEntityWalksOnTheBlock!");
			return;
		}
