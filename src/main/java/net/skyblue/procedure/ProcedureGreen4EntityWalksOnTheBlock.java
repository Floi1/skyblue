...
public class ProcedureGreen4EntityWalksOnTheBlock extends ElementsSkyblueMod.ModElement {
	public ProcedureGreen4EntityWalksOnTheBlock(ElementsSkyblueMod instance) {
		super(instance, 212);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Green4EntityWalksOnTheBlock!");
			return;
		}
