...
public class ProcedureOneonetwoEntityWalksOnTheBlock extends ElementsSkyblueMod.ModElement {
	public ProcedureOneonetwoEntityWalksOnTheBlock(ElementsSkyblueMod instance) {
		super(instance, 26);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure OneonetwoEntityWalksOnTheBlock!");
			return;
		}
