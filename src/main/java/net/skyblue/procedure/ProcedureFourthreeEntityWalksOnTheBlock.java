...
public class ProcedureFourthreeEntityWalksOnTheBlock extends ElementsSkyblueMod.ModElement {
	public ProcedureFourthreeEntityWalksOnTheBlock(ElementsSkyblueMod instance) {
		super(instance, 20);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure FourthreeEntityWalksOnTheBlock!");
			return;
		}
