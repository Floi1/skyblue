...
public class ProcedureNormalskyRightClickedInAir extends ElementsSkyblueMod.ModElement {
	public ProcedureNormalskyRightClickedInAir(ElementsSkyblueMod instance) {
		super(instance, 121);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure NormalskyRightClickedInAir!");
			return;
		}
