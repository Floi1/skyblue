...
public class ProcedureDim6telpert extends ElementsSkyblueMod.ModElement {
	public ProcedureDim6telpert(ElementsSkyblueMod instance) {
		super(instance, 166);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dim6telpert!");
			return;
		}
