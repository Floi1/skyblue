...
public class ProcedureRed2EntityCollidesInTheBlock extends ElementsSkyblueMod.ModElement {
	public ProcedureRed2EntityCollidesInTheBlock(ElementsSkyblueMod instance) {
		super(instance, 183);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Red2EntityCollidesInTheBlock!");
			return;
		}
