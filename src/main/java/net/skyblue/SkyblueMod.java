 ...
 *
 *    Keep the SkyblueModElements object in this class and all calls to this object
...
public class SkyblueMod {
	...
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("skyblue", "skyblue"),
			() -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	public SkyblueModElements elements;

	public SkyblueMod() {
		elements = new SkyblueModElements();
