...
public class OnefiveBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:onefive")
	public static final Block block = null;

	public OnefiveBlock(SkyblueModElements instance) {
		super(instance, 31);
	}
