...
import net.skyblue.procedures.Red5EntityWalksOnTheBlockProcedure;
...
public class Red5Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:red_5")
	public static final Block block = null;

	public Red5Block(SkyblueModElements instance) {
		super(instance, 216);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Red5EntityWalksOnTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
