...
public class LsapBlock extends Block {
	public static final EnumProperty<Direction.Axis> AXIS = BlockStateProperties.AXIS;

	public LsapBlock() {
		super(AbstractBlock.Properties.create(Material.REDSTONE_LIGHT).sound(SoundType.SLIME).hardnessAndResistance(4f, 3.4822022532f).harvestLevel(0).harvestTool(ToolType.AXE));
