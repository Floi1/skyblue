...
import net.skyblue.procedures.Red3EntityWalksOnTheBlockProcedure;
...
public class Red3Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:red_3")
	public static final Block block = null;

	public Red3Block(SkyblueModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Red3EntityWalksOnTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
