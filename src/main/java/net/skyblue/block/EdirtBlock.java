...
public class EdirtBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:edirt")
	public static final Block block = null;

	public EdirtBlock(SkyblueModElements instance) {
		super(instance, 161);
	}
