...
import net.skyblue.procedures.Green2EntityWalksOnTheBlockProcedure;
...
public class Green2Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:green_2")
	public static final Block block = null;

	public Green2Block(SkyblueModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Green2EntityWalksOnTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
