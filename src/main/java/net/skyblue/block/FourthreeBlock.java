...
public class FourthreeBlock extends Block {
	public FourthreeBlock() {
	...
	public static void registerRenderLayer() {
		RenderTypeLookup.setRenderLayer(SkyblueModBlocks.FOURTHREE.get(), RenderType.getCutout());
	}
	...
	public void onEntityWalk(World world, BlockPos pos, Entity entity) {
		...
		Dim1telpertProcedure.execute(entity);
	}
}