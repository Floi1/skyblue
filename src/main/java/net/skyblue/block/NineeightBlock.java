...
public class NineeightBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:nineeight")
	public static final Block block = null;

	public NineeightBlock(SkyblueModElements instance) {
		super(instance, 9);
	}
