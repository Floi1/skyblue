...
public class TwofivesixBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:twofivesix")
	public static final Block block = null;

	public TwofivesixBlock(SkyblueModElements instance) {
		super(instance, 28);
	}
