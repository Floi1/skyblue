...
public class FourtwoBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:fourtwo")
	public static final Block block = null;

	public FourtwoBlock(SkyblueModElements instance) {
		super(instance, 7);
	}
