...
public class D1rBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:d_1r")
	public static final Block block = null;

	public D1rBlock(SkyblueModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(111f, 110f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("d_1r");
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Dim5telpertProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
