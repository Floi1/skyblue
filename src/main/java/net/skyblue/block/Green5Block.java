...
public class Green5Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:green_5")
	public static final Block block = null;

	public Green5Block(SkyblueModElements instance) {
		super(instance, 215);
	}
