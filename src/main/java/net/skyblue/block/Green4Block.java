...
import net.skyblue.procedures.Green4EntityWalksOnTheBlockProcedure;
...
public class Green4Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:green_4")
	public static final Block block = null;

	public Green4Block(SkyblueModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Green4EntityWalksOnTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
