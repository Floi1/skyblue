...
public class EgrassBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:egrass")
	public static final Block block = null;

	public EgrassBlock(SkyblueModElements instance) {
		super(instance, 160);
	}
