...
public class OnethreefourBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:onethreefour")
	public static final Block block = null;

	public OnethreefourBlock(SkyblueModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(111f, 110f).setLightLevel(s -> 7)
					.harvestLevel(3).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("onethreefour");
		}
