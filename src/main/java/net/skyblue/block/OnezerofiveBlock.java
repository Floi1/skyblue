...
public class OnezerofiveBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:onezerofive")
	public static final Block block = null;

	public OnezerofiveBlock(SkyblueModElements instance) {
		super(instance, 15);
	}
