...
import net.skyblue.procedures.Orock1OnBlockRightClickedProcedure;
...
public class Orock1Block extends Block implements IWaterLoggable {
	...
	public static void registerRenderLayer() {
		RenderTypeLookup.setRenderLayer(SkyblueModBlocks.OROCK_1.get(), RenderType.getCutout());
	}
	...
	public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
		...
		Orock1OnBlockRightClickedProcedure.execute();
