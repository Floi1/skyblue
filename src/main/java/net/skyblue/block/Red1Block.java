...
public class Red1Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:red_1")
	public static final Block block = null;

	public Red1Block(SkyblueModElements instance) {
		super(instance, 175);
	}
