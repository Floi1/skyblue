...
import net.skyblue.procedures.GreenEntityCollidesInTheBlockProcedure;
...
public class GreenBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:green")
	public static final Block block = null;

	public GreenBlock(SkyblueModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			GreenEntityCollidesInTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
