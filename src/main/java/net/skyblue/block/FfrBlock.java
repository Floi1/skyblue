...
public class FfrBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:ffr")
	public static final Block block = null;

	public FfrBlock(SkyblueModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(111f, 110f).setLightLevel(s -> 15)
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Dim7telpertProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
