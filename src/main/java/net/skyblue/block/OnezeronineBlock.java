...
public class OnezeronineBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:onezeronine")
	public static final Block block = null;

	public OnezeronineBlock(SkyblueModElements instance) {
		super(instance, 30);
	}
