...
public class OnethreenoeBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:onethreenoe")
	public static final Block block = null;

	public OnethreenoeBlock(SkyblueModElements instance) {
		super(instance, 18);
	}
