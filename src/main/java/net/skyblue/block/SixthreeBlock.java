...
public class SixthreeBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:sixthree")
	public static final Block block = null;

	public SixthreeBlock(SkyblueModElements instance) {
		super(instance, 1);
	}
