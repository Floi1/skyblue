...
public class TwofourBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:twofour")
	public static final Block block = null;

	public TwofourBlock(SkyblueModElements instance) {
		super(instance, 29);
	}
