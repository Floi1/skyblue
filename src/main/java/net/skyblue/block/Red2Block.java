...
import net.skyblue.procedures.Red2EntityCollidesInTheBlockProcedure;
...
public class Red2Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:red_2")
	public static final Block block = null;

	public Red2Block(SkyblueModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Red2EntityCollidesInTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
