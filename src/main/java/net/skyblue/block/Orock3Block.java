...
import net.skyblue.procedures.Orock3OnBlockRightClickedProcedure;
...
public class Orock3Block extends Block implements IWaterLoggable {
	...
	public static void registerRenderLayer() {
		RenderTypeLookup.setRenderLayer(SkyblueModBlocks.OROCK_3.get(), RenderType.getCutout());
	}
	...
	public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
		switch ((Direction) state.get(FACING)) {
			case SOUTH :
				return makeCuboidShape(1, 0, 0, 16, 15, 16);
			case NORTH :
				return makeCuboidShape(0, 0, 0, 15, 15, 16);
			case EAST :
				return makeCuboidShape(0, 0, 0, 16, 15, 15);
			default :
				return makeCuboidShape(0, 0, 1, 16, 15, 16);
		}
	}
	...
	public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
		...
		Orock3OnBlockRightClickedProcedure.execute();
