...
public class OnefourtwoBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:onefourtwo")
	public static final Block block = null;

	public OnefourtwoBlock(SkyblueModElements instance) {
		super(instance, 16);
	}
