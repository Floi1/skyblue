...
public class FournineBlock extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:fournine")
	public static final Block block = null;

	public FournineBlock(SkyblueModElements instance) {
		super(instance, 13);
	}
