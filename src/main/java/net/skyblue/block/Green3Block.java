...
public class Green3Block extends SkyblueModElements.ModElement {
	@ObjectHolder("skyblue:green_3")
	public static final Block block = null;

	public Green3Block(SkyblueModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Green3EntityWalksOnTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
