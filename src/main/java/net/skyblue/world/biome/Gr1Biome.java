...
public class Gr1Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.GG_1.get().getDefaultState(), SkyblueModBlocks.GG_1.get().getDefaultState(), SkyblueModBlocks.GG_1.get().getDefaultState()));
