...
public class Gr2Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.GG_2.get().getDefaultState(), SkyblueModBlocks.GG_2.get().getDefaultState(), SkyblueModBlocks.GG_2.get().getDefaultState()));
