...
public class Gr3Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.GG_3.get().getDefaultState(), SkyblueModBlocks.GG_3.get().getDefaultState(), SkyblueModBlocks.GG_3.get().getDefaultState()));
