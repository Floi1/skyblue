...
public class PlainBiome {
	...
	public static Biome createBiome() {
		BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10027162).setWaterColor(-10027162).setWaterFogColor(-10027162).withSkyColor(-10027162).withFoliageColor(-10027162).withGrassColor(-10027162).build();
