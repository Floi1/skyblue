...
public class GR5Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.GG_5.get().getDefaultState(), SkyblueModBlocks.GG_5.get().getDefaultState(), SkyblueModBlocks.GG_5.get().getDefaultState()));
