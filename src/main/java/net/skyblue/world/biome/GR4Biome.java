...
public class GR4Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.GG_4.get().getDefaultState(), SkyblueModBlocks.GG_4.get().getDefaultState(), SkyblueModBlocks.GG_4.get().getDefaultState()));
