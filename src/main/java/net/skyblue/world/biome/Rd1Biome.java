...
public class Rd1Biome extends SkyblueModElements.ModElement {
	public static Biome biome;

	public Rd1Biome(SkyblueModElements instance) {
		super(instance, 4);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(FourtwoBlock.block.getDefaultState(),
								NineeightBlock.block.getDefaultState(), NineeightBlock.block.getDefaultState())));
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(1f).scale(0.3f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("skyblue:rd_1"));
			}
		}
	}
