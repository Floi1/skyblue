...
public class Fr1Biome extends SkyblueModElements.ModElement {
	public static Biome biome;

	public Fr1Biome(SkyblueModElements instance) {
		super(instance, 169);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Ft1Block.block.getDefaultState(),
								Ft1Block.block.getDefaultState(), Ft1Block.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("skyblue:fr_1"));
			}
		}
	}
