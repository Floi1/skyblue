...
public class Fr1Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.FT_1.get().getDefaultState(), SkyblueModBlocks.FT_1.get().getDefaultState(), SkyblueModBlocks.FT_1.get().getDefaultState()));
