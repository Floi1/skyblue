...
public class PR1Biome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.func_242929_a(new SurfaceBuilderConfig(SkyblueModBlocks.PPR.get().getDefaultState(), SkyblueModBlocks.PPR.get().getDefaultState(), SkyblueModBlocks.PPR.get().getDefaultState()));
