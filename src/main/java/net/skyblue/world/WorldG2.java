...
import net.skyblue.block.BlockGG2;
...
public class WorldG2 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 12;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldG2(ElementsSkyblueMod instance) {
		super(instance, 180);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension g_2 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("g_2", "_g_2", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGG2.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGG2.block.getDefaultState();
		private static final IBlockState FLUID = BlockGG2.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:gr_2")),};
