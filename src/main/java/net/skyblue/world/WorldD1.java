...
public class WorldD1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 8;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldD1(ElementsSkyblueMod instance) {
		super(instance, 125);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension d_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("d_1", "_d_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockDD2.block.getDefaultState();
		private static final IBlockState STONE2 = BlockDD2.block.getDefaultState();
		private static final IBlockState FLUID = BlockDD2.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:dr_1")),};
