...
public class WorldG1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 11;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldG1(ElementsSkyblueMod instance) {
		super(instance, 177);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension g_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("g_1", "_g_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGG1.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGG1.block.getDefaultState();
		private static final IBlockState FLUID = BlockGG1.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:gr_1")),};
