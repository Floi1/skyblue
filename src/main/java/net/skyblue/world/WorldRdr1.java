...
import net.skyblue.block.BlockNine;
...
public class WorldRdr1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldRdr1(ElementsSkyblueMod instance) {
		super(instance, 5);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension rdr_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("rdr_1", "_rdr_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockNine.block.getDefaultState();
		private static final IBlockState STONE2 = BlockNine.block.getDefaultState();
		private static final IBlockState FLUID = BlockNineeight.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:rd_1")),};
