...
public class WorldB1 extends ElementsSkyblueMod.ModElement {
	...
	public WorldB1(ElementsSkyblueMod instance) {
		super(instance, 19);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension b_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("b_1", "_b_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockOnefourtwo.block.getDefaultState();
		private static final IBlockState STONE2 = BlockOnefourtwo.block.getDefaultState();
		private static final IBlockState FLUID = BlockOnethreefour.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:br_1")),};
