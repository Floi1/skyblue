...
public class WorldG5 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 15;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldG5(ElementsSkyblueMod instance) {
		super(instance, 209);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension g_5 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("g_5", "_g_5", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGG5.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGG5.block.getDefaultState();
		private static final IBlockState FLUID = BlockGG5.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:gr_5")),};
