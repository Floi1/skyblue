...
public class WorldG3 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 13;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldG3(ElementsSkyblueMod instance) {
		super(instance, 185);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension g_3 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("g_3", "_g_3", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGG3.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGG3.block.getDefaultState();
		private static final IBlockState FLUID = BlockGG3.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:gr_3")),};
