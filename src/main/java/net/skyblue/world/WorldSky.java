...
import net.skyblue.item.ItemSky;
...
public class WorldSky extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("skyblue:sky_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldSky(ElementsSkyblueMod instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemSky().setUnlocalizedName("sky").setRegistryName("sky"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension sky is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("sky", "_sky", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemSky.block, 0, new ModelResourceLocation("skyblue:sky", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.BOOKSHELF.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("sky_portal");
			setRegistryName("sky_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.BOOKSHELF.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.BOOKSHELF.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockSixthree.block.getDefaultState();
		private static final IBlockState STONE2 = BlockSixthree.block.getDefaultState();
		private static final IBlockState FLUID = BlockSixthree.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:plain")),};
