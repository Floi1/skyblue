...
import net.skyblue.block.BlockOnezeronine;
import net.skyblue.block.BlockOnefive;
...
public class WorldC1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 6;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldC1(ElementsSkyblueMod instance) {
		super(instance, 32);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension c_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("c_1", "_c_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockOnezeronine.block.getDefaultState();
		private static final IBlockState STONE2 = BlockOnezeronine.block.getDefaultState();
		private static final IBlockState FLUID = BlockOnefive.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:cr_1")),};
