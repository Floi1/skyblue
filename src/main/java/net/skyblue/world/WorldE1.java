...
import net.skyblue.block.BlockEwater;
import net.skyblue.block.BlockEstone;
...
public class WorldE1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 9;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldE1(ElementsSkyblueMod instance) {
		super(instance, 158);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension e_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("e_1", "_e_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockEstone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockEstone.block.getDefaultState();
		private static final IBlockState FLUID = BlockEwater.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:er_1")),};
