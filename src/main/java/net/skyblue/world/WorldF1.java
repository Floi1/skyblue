...
public class WorldF1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 10;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldF1(ElementsSkyblueMod instance) {
		super(instance, 169);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension f_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("f_1", "_f_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockFt1.block.getDefaultState();
		private static final IBlockState STONE2 = BlockFt1.block.getDefaultState();
		private static final IBlockState FLUID = BlockFt1.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:fr_1")),};
