...
public class B1Dimension extends SkyblueModElements.ModElement {
	public B1Dimension(SkyblueModElements instance) {
		super(instance, 19);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(OnefourtwoBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:br_1")).getGenerationSettings().getSurfaceBuilder().get()
