...
public class SkyDimension extends SkyblueModElements.ModElement {
	public SkyDimension(SkyblueModElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(SixthreeBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:plain")).getGenerationSettings().getSurfaceBuilder().get()
