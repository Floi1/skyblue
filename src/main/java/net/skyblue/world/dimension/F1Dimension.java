...
public class F1Dimension extends SkyblueModElements.ModElement {
	public F1Dimension(SkyblueModElements instance) {
		super(instance, 169);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(Ft1Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:fr_1")).getGenerationSettings().getSurfaceBuilder().get()
