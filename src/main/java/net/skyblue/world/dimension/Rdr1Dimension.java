...
public class Rdr1Dimension extends SkyblueModElements.ModElement {
	public Rdr1Dimension(SkyblueModElements instance) {
		super(instance, 5);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(NineBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:rd_1")).getGenerationSettings().getSurfaceBuilder().get()
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("skyblue:rdr_1"))) {
			...
			SpawnProcedure.executeProcedure(Stream
