...
public class G3Dimension extends SkyblueModElements.ModElement {
	public G3Dimension(SkyblueModElements instance) {
		super(instance, 185);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(GG3Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:gr_3")).getGenerationSettings().getSurfaceBuilder().get()
