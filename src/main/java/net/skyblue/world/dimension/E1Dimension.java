...
public class E1Dimension extends SkyblueModElements.ModElement {
	public E1Dimension(SkyblueModElements instance) {
		super(instance, 158);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(EstoneBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:er_1")).getGenerationSettings().getSurfaceBuilder().get()
