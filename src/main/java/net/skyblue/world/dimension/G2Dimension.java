...
public class G2Dimension extends SkyblueModElements.ModElement {
	public G2Dimension(SkyblueModElements instance) {
		super(instance, 180);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(GG2Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:gr_2")).getGenerationSettings().getSurfaceBuilder().get()
