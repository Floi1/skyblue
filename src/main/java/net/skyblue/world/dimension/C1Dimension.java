...
public class C1Dimension extends SkyblueModElements.ModElement {
	public C1Dimension(SkyblueModElements instance) {
		super(instance, 32);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(OnezeronineBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:cr_1")).getGenerationSettings().getSurfaceBuilder().get()
