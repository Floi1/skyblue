...
public class G5Dimension extends SkyblueModElements.ModElement {
	public G5Dimension(SkyblueModElements instance) {
		super(instance, 209);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(GG5Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:gr_5")).getGenerationSettings().getSurfaceBuilder().get()
