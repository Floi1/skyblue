...
public class G1Dimension extends SkyblueModElements.ModElement {
	public G1Dimension(SkyblueModElements instance) {
		super(instance, 177);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(GG1Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:gr_1")).getGenerationSettings().getSurfaceBuilder().get()
