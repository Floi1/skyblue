...
public class A1Dimension extends SkyblueModElements.ModElement {
	public A1Dimension(SkyblueModElements instance) {
		super(instance, 80);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:ar_1")).getGenerationSettings().getSurfaceBuilder().get()
