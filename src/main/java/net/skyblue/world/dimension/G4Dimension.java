...
public class G4Dimension extends SkyblueModElements.ModElement {
	public G4Dimension(SkyblueModElements instance) {
		super(instance, 195);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(GG4Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:gr_4")).getGenerationSettings().getSurfaceBuilder().get()
