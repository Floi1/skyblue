...
public class D1Dimension extends SkyblueModElements.ModElement {
	public D1Dimension(SkyblueModElements instance) {
		super(instance, 125);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(DD2Block.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("skyblue:dr_1")).getGenerationSettings().getSurfaceBuilder().get()
