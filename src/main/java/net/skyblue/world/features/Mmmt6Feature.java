...
public class Mmmt6Feature extends StructureModFeature {
	private static Mmmt6Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_6"), CONFIGURED_FEATURE);
		return FEATURE;
	}
