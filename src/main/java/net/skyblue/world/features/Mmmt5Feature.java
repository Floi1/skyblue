...
public class Mmmt5Feature extends StructureModFeature {
	private static Mmmt5Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_5"), CONFIGURED_FEATURE);
		return FEATURE;
	}
