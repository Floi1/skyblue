...
public class FFR1FeatureFeature extends StructureModFeature {
	private static FFR1FeatureFeature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public FFR1FeatureFeature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new FFR1FeatureFeature();
		CONFIGURED_FEATURE = FEATURE
				.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:frr1"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState(), Blocks.AIR.getDefaultState()), new Vector3i(0, -1, 0))).chance(1000)
				.square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:ffr_1_feature"), CONFIGURED_FEATURE);
		return FEATURE;
	}
