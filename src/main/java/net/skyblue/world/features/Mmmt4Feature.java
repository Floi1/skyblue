...
public class Mmmt4Feature extends StructureModFeature {
	private static Mmmt4Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_4"), CONFIGURED_FEATURE);
		return FEATURE;
	}
