...
public class MMppFeature extends StructureModFeature {
	private static MMppFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new MMppFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:mmp"), false, false, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, 0, 0))).chance(100).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:m_mpp"), CONFIGURED_FEATURE);
		return FEATURE;
	}
