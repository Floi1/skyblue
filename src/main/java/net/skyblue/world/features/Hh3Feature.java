...
public class Hh3Feature extends StructureModFeature {
	private static Hh3Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new Hh3Feature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:hh"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, 0, 0))).chance(1000).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:hh_3"), CONFIGURED_FEATURE);
		return FEATURE;
	}
