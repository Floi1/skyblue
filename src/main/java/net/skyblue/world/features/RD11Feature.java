...
public class RD11Feature extends StructureModFeature {
	private static RD11Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new RD11Feature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:rd11"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, 0, 0))).chance(22).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:rd_11"), CONFIGURED_FEATURE);
		return FEATURE;
	}
