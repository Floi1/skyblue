...
public class Mmmt2Feature extends StructureModFeature {
	private static Mmmt2Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_2"), CONFIGURED_FEATURE);
		return FEATURE;
	}
