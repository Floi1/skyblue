...
public class Mmmt14Feature extends StructureModFeature {
	private static Mmmt14Feature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public Mmmt14Feature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new Mmmt14Feature();
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_14"), CONFIGURED_FEATURE);
		return FEATURE;
	}
