...
public class Mmmt3Feature extends StructureModFeature {
	private static Mmmt3Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_3"), CONFIGURED_FEATURE);
		return FEATURE;
	}
