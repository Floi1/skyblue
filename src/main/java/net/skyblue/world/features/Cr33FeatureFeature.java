...
public class Cr33FeatureFeature extends StructureModFeature {
	private static Cr33FeatureFeature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public Cr33FeatureFeature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new Cr33FeatureFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:c33"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, 0, 0))).chance(10).square()
				.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(63, (256 - 0) - 63, (256 - 0))));
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:cr_33_feature"), CONFIGURED_FEATURE);
		return FEATURE;
	}
