...
public class Mmmt7Feature extends StructureModFeature {
	private static Mmmt7Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_7"), CONFIGURED_FEATURE);
		return FEATURE;
	}
