...
public class Jp3Feature extends RandomPatchFeature {
	private static Jp3Feature INSTANCE = null;
	...
	public static Feature<?> feature() {
		INSTANCE = new Jp3Feature();
		CONFIGURED_FEATURE = INSTANCE.withConfiguration(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(SkyblueModBlocks.JP_3.get().getDefaultState()), SimpleBlockPlacer.PLACER)

				.tries(24).build()).func_242731_b(10).square().range(128);
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:jp_3"), CONFIGURED_FEATURE);
		return INSTANCE;
	}
