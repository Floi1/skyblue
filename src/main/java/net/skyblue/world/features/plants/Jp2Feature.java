...
public class Jp2Feature extends RandomPatchFeature {
	private static Jp2Feature INSTANCE = null;
	...
	public static Feature<?> feature() {
		INSTANCE = new Jp2Feature();
		CONFIGURED_FEATURE = INSTANCE.withConfiguration(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(SkyblueModBlocks.JP_2.get().getDefaultState()), SimpleBlockPlacer.PLACER)

				.tries(24).build()).func_242731_b(10).square().range(128);
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:jp_2"), CONFIGURED_FEATURE);
		return INSTANCE;
	}
