...
public class Mmmt10Feature extends StructureModFeature {
	private static Mmmt10Feature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public Mmmt10Feature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new Mmmt10Feature();
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_10"), CONFIGURED_FEATURE);
		return FEATURE;
	}
