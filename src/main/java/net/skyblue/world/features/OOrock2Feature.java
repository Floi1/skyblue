...
public class OOrock2Feature extends StructureModFeature {
	private static OOrock2Feature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public OOrock2Feature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new OOrock2Feature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:orock2"), true, true, ImmutableList.of(Blocks.VOID_AIR.getDefaultState()), new Vector3i(0, 0, 0))).chance(250).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:o_orock_2"), CONFIGURED_FEATURE);
		return FEATURE;
	}
