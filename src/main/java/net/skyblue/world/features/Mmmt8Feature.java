...
public class Mmmt8Feature extends StructureModFeature {
	private static Mmmt8Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_8"), CONFIGURED_FEATURE);
		return FEATURE;
	}
