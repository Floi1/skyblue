...
public class HhFeature extends StructureModFeature {
	private static HhFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:hh"), CONFIGURED_FEATURE);
		return FEATURE;
	}
