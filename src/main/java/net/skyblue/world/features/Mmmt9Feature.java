...
public class Mmmt9Feature extends StructureModFeature {
	private static Mmmt9Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_9"), CONFIGURED_FEATURE);
		return FEATURE;
	}
