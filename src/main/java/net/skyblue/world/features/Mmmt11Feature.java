...
public class Mmmt11Feature extends StructureModFeature {
	private static Mmmt11Feature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public Mmmt11Feature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new Mmmt11Feature();
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_11"), CONFIGURED_FEATURE);
		return FEATURE;
	}
