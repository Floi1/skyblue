...
public class Hh4Feature extends StructureModFeature {
	private static Hh4Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:hh_4"), CONFIGURED_FEATURE);
		return FEATURE;
	}
