...
public class HouseFeature extends StructureModFeature {
	private static HouseFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new HouseFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:iii"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, -4, 0))).chance(15).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:house"), CONFIGURED_FEATURE);
		return FEATURE;
	}
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = ImmutableSet.of(new ResourceLocation("skyblue:ir_1"));
