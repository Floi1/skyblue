...
public class NnbridgeFeature extends StructureModFeature {
	private static NnbridgeFeature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public NnbridgeFeature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new NnbridgeFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:nnbrige"), false, false, ImmutableList.of(Blocks.AIR.getDefaultState()), new Vector3i(0, 0, 0))).chance(40).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:nnbridge"), CONFIGURED_FEATURE);
		return FEATURE;
	}
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = ImmutableSet.of(new ResourceLocation("skyblue:nr_1"));
