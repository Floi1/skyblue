...
public class C2FeatureFeature extends StructureModFeature {
	private static C2FeatureFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new C2FeatureFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:c2"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, -1, 0))).chance(10).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:c_2_feature"), CONFIGURED_FEATURE);
		return FEATURE;
	}
