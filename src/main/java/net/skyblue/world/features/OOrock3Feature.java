...
public class OOrock3Feature extends StructureModFeature {
	private static OOrock3Feature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public OOrock3Feature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new OOrock3Feature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:orock3"), true, true, ImmutableList.of(Blocks.VOID_AIR.getDefaultState()), new Vector3i(0, 0, 0))).chance(350).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:o_orock_3"), CONFIGURED_FEATURE);
		return FEATURE;
	}
