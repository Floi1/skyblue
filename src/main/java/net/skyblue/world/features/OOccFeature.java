...
public class OOccFeature extends StructureModFeature {
	private static OOccFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new OOccFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:oocc"), true, true, ImmutableList.of(Blocks.VOID_AIR.getDefaultState()), new Vector3i(0, 0, 0))).chance(1000).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:o_occ"), CONFIGURED_FEATURE);
		return FEATURE;
	}
