...
public class Hh2Feature extends StructureModFeature {
	private static Hh2Feature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:hh_2"), CONFIGURED_FEATURE);
		return FEATURE;
	}
