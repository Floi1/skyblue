...
public class LtreeFeature extends StructureModFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:llltree"), true, true, ImmutableList.of(Blocks.AIR.getDefaultState()), new Vector3i(0, 0, 0))).chance(250).square();
