...
public class Mmmt12Feature extends StructureModFeature {
	private static Mmmt12Feature FEATURE = null;
	private static ConfiguredFeature<?, ?> CONFIGURED_FEATURE = null;

	public Mmmt12Feature() {
		super(StructureModFeatureConfiguration.CODEC);
	}

	public static Feature<?> feature() {
		Random random = new Random();
		FEATURE = new Mmmt12Feature();
		...
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:mmmt_12"), CONFIGURED_FEATURE);
		return FEATURE;
	}
