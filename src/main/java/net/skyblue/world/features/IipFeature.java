...
public class IipFeature extends StructureModFeature {
	private static IipFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		FEATURE = new IipFeature();
		CONFIGURED_FEATURE = FEATURE.withConfiguration(new StructureModFeatureConfiguration(new ResourceLocation("skyblue:iip"), true, true, ImmutableList.of(Blocks.STRUCTURE_BLOCK.getDefaultState()), new Vector3i(0, 0, 0))).chance(1000).square();
		Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("skyblue:iip"), CONFIGURED_FEATURE);
		return FEATURE;
	}
