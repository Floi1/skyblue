...
import net.skyblue.block.BlockGG4;
...
public class WorldG4 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 14;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldG4(ElementsSkyblueMod instance) {
		super(instance, 195);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension g_4 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("g_4", "_g_4", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGG4.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGG4.block.getDefaultState();
		private static final IBlockState FLUID = BlockGG4.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:gr_4")),};
