...
public class WorldA1 extends ElementsSkyblueMod.ModElement {
	public static int DIMID = 7;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldA1(ElementsSkyblueMod instance) {
		super(instance, 80);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension a_1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("a_1", "_a_1", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.GLASS.getDefaultState();
		private static final IBlockState STONE2 = Blocks.GLASS.getDefaultState();
		private static final IBlockState FLUID = Blocks.GLASS.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("skyblue:ar_1")),};
