...
public class StructureDDDDR3 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDR3(ElementsSkyblueMod instance) {
		super(instance, 145);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddr3"));
				if (template == null)
					return;
