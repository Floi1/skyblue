...
public class StructureCr3333 extends ElementsSkyblueMod.ModElement {
	public StructureCr3333(ElementsSkyblueMod instance) {
		super(instance, 62);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "c3333"));
				if (template == null)
					return;
