...
public class StructureDDDDR1 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDR1(ElementsSkyblueMod instance) {
		super(instance, 143);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddr1"));
				if (template == null)
					return;
