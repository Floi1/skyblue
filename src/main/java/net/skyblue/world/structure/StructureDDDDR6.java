...
public class StructureDDDDR6 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDR6(ElementsSkyblueMod instance) {
		super(instance, 148);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddr6"));
				if (template == null)
					return;
