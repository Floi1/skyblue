...
public class StructureDDDDR5 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDR5(ElementsSkyblueMod instance) {
		super(instance, 147);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddr5"));
				if (template == null)
					return;
