...
public class StructureDDDDR7 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDR7(ElementsSkyblueMod instance) {
		super(instance, 149);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddr7"));
				if (template == null)
					return;
