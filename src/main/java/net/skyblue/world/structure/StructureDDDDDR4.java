...
public class StructureDDDDDR4 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDDR4(ElementsSkyblueMod instance) {
		super(instance, 154);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddd4"));
				if (template == null)
					return;
