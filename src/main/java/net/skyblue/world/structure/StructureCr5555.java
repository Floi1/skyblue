...
public class StructureCr5555 extends ElementsSkyblueMod.ModElement {
	public StructureCr5555(ElementsSkyblueMod instance) {
		super(instance, 72);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "c5555"));
				if (template == null)
					return;
