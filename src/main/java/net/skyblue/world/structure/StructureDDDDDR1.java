...
public class StructureDDDDDR1 extends ElementsSkyblueMod.ModElement {
	public StructureDDDDDR1(ElementsSkyblueMod instance) {
		super(instance, 151);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "dddd1"));
				if (template == null)
					return;
