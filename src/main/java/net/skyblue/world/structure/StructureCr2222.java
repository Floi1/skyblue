...
public class StructureCr2222 extends ElementsSkyblueMod.ModElement {
	public StructureCr2222(ElementsSkyblueMod instance) {
		super(instance, 60);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "c2222"));
				if (template == null)
					return;
