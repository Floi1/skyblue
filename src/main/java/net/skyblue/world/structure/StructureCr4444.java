...
public class StructureCr4444 extends ElementsSkyblueMod.ModElement {
	public StructureCr4444(ElementsSkyblueMod instance) {
		super(instance, 64);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("skyblue", "c4444"));
				if (template == null)
					return;
